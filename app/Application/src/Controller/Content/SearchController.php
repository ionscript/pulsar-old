...
class SearchController extends Controller
{
	public function indexAction() {
		...
		if (isset($this->request->get['search']) || isset($this->request->get['tag'])) {
			...
			$results = $this->model('content/post')->getProducts($filter_data);
			...
			foreach ($results as $result) {
				$data['posts'][] = [
					...
					'href'        => $this->url->link('content/post', 'id=' . $result['id'])
				];
			}
			...
			foreach($limits as $value) {
				$data['limits'][] = [
					'text'  => $value,
					'value' => $value,
					'href'  => $this->url->link('content/search' . '&limit=' . $value)
				];
			}
			...
			$pagination->url = $this->url->link('content/search', '&page={page}');
		...
		$data['column_left'] = $this->controller('common/column_left');
		$data['column_right'] = $this->controller('common/column_right');
		$data['content_top'] = $this->controller('common/content_top');
		$data['content_bottom'] = $this->controller('common/content_bottom');
		$data['footer'] = $this->controller('common/footer');
		$data['header'] = $this->controller('common/header');
