                ...
                <div class="table-responsive">
                    <table class="js-table-sections table table-striped table-vcenter">
                        ...
                        <tr>
                            ...
                            <th class="text-center" style="width: 10%;"><?php echo $column_width; ?></th>
                            <th class="text-center" style="width: 15%;"><?php echo $column_status; ?></th>
                            <th class="text-center" style="width: 10%;"><?php echo $column_sort_order; ?></th>
                        ...
                        <?php foreach ($extensions as $extension) { ?>
                            <tr>
                                ...
                                <td class="text-center"><?php echo $extension['width'] ?></td>
