                ...
                <div class="block-content">
                    ...
                    <table class="table table-bordered table-hover table-striped table-checkable">
                        ...
                        <tr>
                            ...
                            <th class="hidden-xs text-center" style="width: 5%;"><?php echo $column_approval; ?></th>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($groups as $group) { ?>
                                <tr>
                                    ...
                                    <td class="font-w600 text-middle"><?php echo $group['name']; ?></td>
                                    <td class="hidden-xs text-center text-middle">
                                        <span class="label label-<?php echo $group['approval'] ? 'success' : 'warning'; ?>"><?php echo $group['approval'] ? 'enabled' : 'disabled'; ?></span>
                                    </td>
                                    <td class="text-center text-middle">
                                        <div class="btn-group">
                                            <a href="<?php echo $edit; ?>&id=<?php echo $group['id']; ?>"
                                               data-toggle="tooltip"
                                        ...
                                        <div class="btn-group">
                                            <a href="<?php echo $delete; ?>&id=<?php echo $group['id']; ?>"
