        ...
        <div class="row">
            <div class="col-xs-12 col-sm-4">
                <a class="block block-link-hover3 text-center"
                   href="<?php echo $add; ?>">
                    ...
                    <div class="block-content block-content-full block-content-mini bg-gray-lighter text-success font-w600"><?php echo $button_add; ?></div>
                </a>
            </div>
            <div class="col-xs-12 col-sm-4">
            ...
            <div class="col-xs-12 col-sm-4">
                <a class="block block-link-hover3 text-center js-swal-confirm">
                    ...
                    <div class="block-content block-content-full block-content-mini bg-gray-lighter text-danger font-w600"><?php echo $button_delete; ?></div>
                </a>
            </div>
        </div>
        <div class="block">
            ...
            <div class="block-content">
                ...
                <table class="table table-bordered table-hover table-striped js-dataTable-full js-table-checkable">
                    ...
                    <tr>
                        ...
                        <th class="text-center" style="width: 15%;"><?php echo $column_group; ?></th>
                        <th class="text-center" style="width: 15%;"><?php echo $column_email; ?></th>
                        <th class="hidden-xs text-center" style="width: 10%;"><?php echo $column_ip; ?></th>
                                ...
                                <tr>
                                    <td class="text-center text-middle">
                                        <label class="css-input css-checkbox css-checkbox-primary">
                                            <input type="checkbox" name="selected[]" value="<?php echo $user['id']; ?>"><span></span>
                                        </label>
                                    </td>
                                    <td><img class="img-avatar img-avatar-thumb" src="<?php echo $user['image'] ?: $placeholder; ?>" alt=""></td>
                                    <td class="font-w600 text-middle"><?php echo $user['username']; ?></td>
                                    <td class="font-w600 text-middle"><?php echo $user['name']; ?></td>
                                    <td class="text-middle text-center"><i><?php echo $user['group']; ?></i></td>
                                    <td class="font-w600 text-middle text-center"><?php echo $user['email']; ?></td>
                                    <td class="hidden-xs text-middle text-center"><i><?php echo $user['ip']; ?></i></td>
                                    <td class="hidden-xs text-center text-middle">
                                        <span class="label label-<?php echo $user['status'] ? 'success' : 'warning'; ?>"><?php echo $user['status'] ? $text_enabled : $text_disabled; ?></span>
                                    </td>
                                    <td class="text-center text-middle">
                                        <div class="btn-group">
                                            <a href="<?php echo $edit; ?>&id=<?php echo $user['id']; ?>"
                                               data-toggle="tooltip"
                                        ...
                                        <?php if($user['unlock']) { ?>
                                            <div class="btn-group">
                                                <a href="<?php echo $user['unlock']; ?>"
                                                   data-toggle="tooltip"
                                                   title="<?php echo $button_unlock; ?>"
                                                   class="btn btn-sm btn-default">
                                        ...
                                        <?php } ?>
                                        <div class="btn-group">
                                            <a href="<?php echo $delete; ?>&id=<?php echo $user['id']; ?>"
