                    ...
                    <tbody>
                        ...
                        <?php foreach ($posts as $post) { ?>
                            <tr>
                                ...
                                <td><img class="" src="<?php echo $post['image']; ?>" alt=""></td>
                                <td class="font-w600 text-middle"><?php echo $post['name']; ?></td>
                                <td class="font-w600 text-center text-middle"><?php echo $post['viewed']; ?></td>
                                <td class="hidden-xs text-center text-middle">
                                    <span class="label label-<?php echo $post['status'] ? 'success' : 'warning'; ?>"><?php echo $post['status'] ? 'enabled' : 'disabled'; ?></span>
                                </td>
                                <td class="text-center text-middle">
                                    <div class="btn-group">
                                        <a href="<?php echo $edit; ?>&id=<?php echo $post['id']; ?>"
                                           data-toggle="tooltip"
