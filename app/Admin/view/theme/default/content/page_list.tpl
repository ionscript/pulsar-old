            ...
            <div class="block-content">
                ...
                <table class="table table-bordered table-hover table-striped js-dataTable-full js-table-checkable">
                    ...
                    <tr>
                        ...
                        <th class="hidden-xs text-center" style="width: 5%;"><?php echo $column_view; ?></th>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($pages as $page) { ?>
                            <tr>
                                ...
                                <td class="font-w600 text-middle"><?php echo $page['name']; ?></td>
                                <td class="font-w600 text-center text-middle"><?php echo $page['viewed']; ?></td>
                                <td class="hidden-xs text-center text-middle">
                                    <span class="label label-<?php echo $page['status'] ? 'success' : 'warning'; ?>"><?php echo $page['status'] ? 'enabled' : 'disabled'; ?></span>
                                </td>
                                <td class="text-center text-middle">
                                    <div class="btn-group">
                                        <a href="<?php echo $edit; ?>&id=<?php echo $page['id']; ?>"
                                           data-toggle="tooltip"
                                    ...
                                    <div class="btn-group">
                                        <a href="<?php echo $delete; ?>&id=<?php echo $page['id']; ?>"
